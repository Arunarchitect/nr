      ...
      <div className="w-full h-screen absolute top-0 left-0 bg-white/50">
        <div className="max-w-[650px] m-auto h-full w-full flex flex-col justify-center lg:items-start items-center">
          ...
          <div className="flex justify-between pt-12 max-w-[200px] w-full">
            <FaFacebookF className="cursor-pointer " size={60} onClick={handleFaceClick} />
            <FaInstagram className="cursor-pointer " size={60} onClick={handleInstaClick} />
          </div>
          <h3 className='pt-6'>Scroll down to donate!</h3>
        </div>
      </div>
    </div>
  );
